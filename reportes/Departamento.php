...
class PDF extends PDF_MC_Table
{
    ...
    $this->Cell(3.1, 0.6, 'INVE-006-REPO', 0, 0, 'C');

    // Versión
    $this->SetXY(13.2, 2.25);
    $this->Cell(3.5, 0.6, utf8_decode('Versión:'), 0, 0, 'L');
    $this->Cell(3.1, 0.6, '000', 0, 0, 'C');

    // Fecha
    $this->SetXY(13.2, 3.25);
    $this->Cell(3.5, 0.6, utf8_decode("Fecha de\nvigencia:"), 0, 0, 'L');
    $this->Cell(3.1, 0.6, '22/10/2025', 0, 0, 'C');
