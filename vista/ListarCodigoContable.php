...
$config = new Config();
$datos = $config->getAllCodigoContable();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<title>C&oacute;digo Contable</title>
...
<script type="text/javascript">
  ...
  window.location.href='EditarBien.php?idcodconta='+id;
  });
  }
  function delete_id(id)
  {
  $('#elimSi').click(function(event) {
  window.location.href='../controlador/Config_controlador.php?delcodconta='+id;
  });
  }
  ...
  <body class="layout-top-nav" >
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>C&oacute;digo Contable</a></li>
          <li><a href="#"><?php ?></a></li>
        </ol>
      </section>
      <!-- Main content -->
      <section class="content">
        ...
        <tbody>
            <div><input class="btn btn-warning btn-xs" type="button" onclick=" location.href='../vista/IngresarConfig.php?tipo=codconta' " target="frameprincipal" value="Nuevo Código Contable"/></div><br>
          <?php
            foreach($datos as $val) {
          ?>
          <tr class="center aligned">
              <td><?php echo $val["codconta"]; ?></td> 
            <td><?php echo $val["nombre"]; ?></td> 
            <td><center>
                <table>
                <tr><td>
                &nbsp; &nbsp;
                <a onclick="edt_id(<?php echo $val['idcodcontable']; ?>); window.parent.$('body').animate({scrollTop:0}, 'slow');" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalEditar">
                <i class="fa fa-edit" title="Editar"></i>&nbsp; Editar
                </a></td><td>&nbsp; &nbsp;
                <a onclick="delete_id(<?php echo $val['idcodcontable']; ?>); window.parent.$('body').animate({scrollTop:0}, 'slow');" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalEliminar" id="eliminar">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Codigo Contable</h4>
          </div>
          <div class="modal-body">
            <b><p>¿Seguro que desea editar el codigo contable?</p></b>
          </div>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <b><p>¿Seguro que desea Eliminar el codigo contable?</p></b>
