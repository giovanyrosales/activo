...
$datos =  $bienes->getDonacion($iddonacion);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#">Modificar Donaci&oacute;n</a></li>
        </ol>
      </section>
      <!-- Main content -->
              ...
              <form role="form" name="form_1" id="form_1" enctype="multipart/form-data" class="form-horizontal" method="post" action="../controlador/Bien_controlador.php" <!-- form horizontal acts as a row -->  
                          ...
                          <label class="col-md-3 control-label" >Nombre y/o Descripci&oacute;n del Bien:</label>
                             <div class="col-md-7">
                                 <div class="input_container">
                                    ...
                                    <input id="iddonacion" name="iddonacion" class="form-control" type="hidden" value="<?php echo $datos["iddonacion"]; ?>"> 
                                 </div>
                             </div>
                        </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="pull-right" style="margin-right: 15%">
                            <button class="btn btn-primary mr5" name="actualizardonacion" id="saveForm1" type="submit" >Guardar</button>
                            <input class="btn btn-default" type="button" onclick=" location.href='../vista/ListarDonacion.php'" target="frameprincipal" value="Cancelar"/> 
                     </div>
            </form>
          </div>
        </div>
