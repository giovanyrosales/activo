      ...
      if (keyword.length > min_length) {
        $.ajax({
          ...
          if (isset($_GET["tipo"]) && $_GET["tipo"] != null) {
            if ($_GET["tipo"] == 1) {
              echo " url: '../modelo/ListarM_modelo.php?venta=1&tipo=1',";
            } else if ($_GET["tipo"] == 3) {
              echo " url: '../modelo/ListarM_modelo.php?venta=1&tipo=3',";
            }
          } else {
            echo " url: '../modelo/ListarM_modelo.php?venta=1&tipo=1',";
          }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="#">Registrar Venta de un Bien</a></li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <form role="form" name="form_1" id="form_1" class="form-horizontal" enctype="multipart/form-data" method="post" action="../controlador/Venta_controlador.php" <!-- form horizontal acts as a row -->
            ...
            <div class="form-group">
              <div class="form-inline">
                ...
                <div class="col-md-2">
                  <input id="precio" name="precio" class="form-control" type="number" step="0.01" min="0.01" placeholder="$0.00" required>
                </div>
            ...
            <div class="pull-right" style="margin-right: 15%">
              <button class="btn btn-primary mr5" name="agregarventa" id="saveForm1" type="submit">Guardar</button>
              <input class="btn btn-default" type="button" onclick=" location.href='../vista/ListarVentas.php'" target="frameprincipal" value="Cancelar" />
            </div>
          </form>
        </div>
      </div>
