      ...
      <script type="text/javascript">
        function edt_id(id) {
          $('#editSi').click(function(event) {
            window.location.href = 'EditarDonacion.php?iddonacion=' + id;
          });
        }

        function delete_id(id) {
          $('#elimSi').click(function(event) {
            window.location.href = '../controlador/Bien_controlador.php?deldonacion=' + id;
          });
        }
    ...
    <body class="layout-top-nav">
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Donaciones</a></li>
            <li><a href="#">Donaciones Registradas</a></li>
          </ol>
        </section>
        <!-- Main content -->
        <section class="content">
          ...
          if (isset($_GET["del"]) and $_GET["del"] == "2") {
            echo '<div class="alert alert-danger">
              ...
              <strong>Error! </strong>   No se eliminar el registro de la Donacion.
              </div>';
          } else   if (isset($_GET["del"]) and $_GET["del"] == "1") {
            echo '<div class="alert alert-success">
              <span class="close" data-dismiss="alert">&times;</span>
              <strong>Correcto! </strong> Registro de donacion Eliminado, el documento se conservara.
              </div>';
          }
          if (isset($_GET["act"]) and $_GET["act"] == "2") {
            echo '<div class="alert alert-danger">
              <span class="close" data-dismiss="alert">&times;</span>
              <strong>Error! </strong> No se pudo actualizar el registro de Donacion.
              </div>';
          } else   if (isset($_GET["act"]) and $_GET["act"] == "1") {
            echo '<div class="alert alert-success">
              <span class="close" data-dismiss="alert">&times;</span>
              <strong>Correcto! </strong> Registro de Donacion Modificado con exito.
              </div>';
          } ?>
          <!-- Default box -->
            ...
            <div class="box-body">
              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                <table id="example" class="table table-bordered table-striped text-center table-hover table-condensed">
                  ...
                  <tbody>
                    <div><input class="btn btn-warning btn-xs" type="button" onclick=" location.href='../vista/IngresarDonacion.php' " target="frameprincipal" value="Agregar Donacion" /></div><br>
                    <?php
                          ...
                          <center>
                            <table>
                              <tr>
                                <td>
                                  &nbsp; &nbsp;
                                  <a onclick="edt_id(<?php echo $val['iddonacion']; ?>); window.parent.$('body').animate({scrollTop:0}, 'slow');" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalEditar">
                                    <i class="fa fa-edit" title="Editar"></i>&nbsp; Editar
                                  </a></td>
                                <td>&nbsp; &nbsp;
                                  <a onclick="delete_id(<?php echo $val['iddonacion']; ?>); window.parent.$('body').animate({scrollTop:0}, 'slow');" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalEliminar" id="eliminar">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <b>
                <p>¿Seguro que desea editar el registro de Donaci&oacute;n?</p>
              </b>
            </div>
      ...
      <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <b>
                <p>¿Seguro que desea Eliminar el Registro de Donaci&oacute;n?</p>
              </b>
