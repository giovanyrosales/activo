    ...
    <head>
        ...
        <script>
            ...
            function autocomplet() {
                ...
                var ajax_data = {
                    "tipo": '2', //document.getElementById('tipo').value,
                    "keyword": keyword
                };
                if (keyword.length > min_length) {
                    $.ajax({
                        url: '../modelo/ListarM_modelo.php?donacion=1',
                        type: 'POST',
                        data: ajax_data,
            ...
            <section class="content">
                ...
                <div class="box box-solid box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">Registro de Donacion</h3>
                    </div>
                    <div class="box-body">              
                        <form role="form" name="form_1" id="form_1" class="form-horizontal" enctype="multipart/form-data" method="post" action="../controlador/Bien_controlador.php" <!-- form horizontal acts as a row -->  
                            ...
                            <div class="pull-right" style="margin-right: 15%">
                                <button class="btn btn-primary mr5" name="agregardonacion" id="saveForm1" type="submit" >Guardar</button>
